...
#define ST_RES_Pin GPIO_PIN_6
#define ST_RES_GPIO_Port GPIOA
#define ST_CS_Pin GPIO_PIN_0
#define ST_CS_GPIO_Port GPIOB
#define ST_BLK_Pin GPIO_PIN_1
#define ST_BLK_GPIO_Port GPIOB
#define CTP_RES_Pin GPIO_PIN_12
#define CTP_RES_GPIO_Port GPIOB
...
#define BAT_CHG_DET_Pin GPIO_PIN_15
#define BAT_CHG_DET_GPIO_Port GPIOB
#define SD_CD_Pin GPIO_PIN_8
#define SD_CD_GPIO_Port GPIOA
#define PWR_KEY_DET_Pin GPIO_PIN_3
#define PWR_KEY_DET_GPIO_Port GPIOB
