...
#define LCD_RESET_GPIO_Port ST_RES_GPIO_Port
#define LCD_RESET_Pin ST_RES_Pin
#define LCD_CS_GPIO_Port ST_CS_GPIO_Port
#define LCD_CS_Pin ST_CS_Pin
#define LCD_DCX_GPIO_Port ST_DC_GPIO_Port
#define LCD_DCX_Pin ST_DC_Pin
...
void lv_port_disp_init(void)
{
    ...
    //后续使用的是芯片内部CCM内存，与DMA冲突，使用lv_malloc 会申请内存失败，故手动分配两块内存P
    static uint8_t buf1[MY_DISP_HOR_RES * MY_DISP_VER_RES / 5] ={0};
    static uint8_t buf2[MY_DISP_HOR_RES * MY_DISP_VER_RES / 5] ={0};
